...
const nav = computed(() => [
  { label: t('navigation.overview'), icon: 'chart-line', to: { name: 'merchant-overview' } },
  { label: t('navigation.orders'), icon: 'bag-shopping', to: { name: 'merchant-orders' } },
  { label: t('navigation.sessions'), icon: 'comments', to: { name: 'merchant-sessions' } },
  { label: t('navigation.menu'), icon: 'utensils', to: { name: 'merchant-menu' } },
  { label: t('navigation.menuImport'), icon: 'upload', to: { name: 'merchant-menu-import' } },
  { label: t('navigation.whatsappLines'), icon: 'phone', to: { name: 'merchant-whatsapp-lines' } },
  { label: t('navigation.settings'), icon: 'sliders', to: { name: 'merchant-settings' } }
])
